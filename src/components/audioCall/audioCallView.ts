...
class AudioCallView{
    ...
    showResultGame(){   
        let point = gameController.arrTrueAnswer.length*100
...
// export function renderGamePage(arrWordsRus:string[], wordEn:string, voiceEn:string, imageEn: string, wordRus:string){
//     clearMainFooter()
//     main.innerHTML = `
//     <div class="game">
//     <div class="close_btn">
...
// export function showResultGame(){   
//     let point = gameController.arrTrueAnswer.length*100
//     let percent = gameController.arrTrueAnswer.length/20*100
//     clearMainFooter()  
//     main.innerHTML = `
...
//           <button class="close_result_game">Закрыть</button>
//         </div>`
//         generateLi(gameController.arrTrueAnswer, 'known_item', 'word_know');
//         generateLi(gameController.arrFalseAnswer, 'mistake_item', 'word_mistake')
// }
